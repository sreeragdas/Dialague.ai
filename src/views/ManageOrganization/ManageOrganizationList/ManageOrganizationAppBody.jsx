...
const CHANGE_PERMISSIONS = "change_organization";
const DELETE_PERMISSIONS = "delete_organization";
...
const ManageOrganizationAppBody = () => {
  ...
  const onConfirmDelete = async () => {
    return client.delete(`/organization/${selectedDeleteRow.id}/`);
  };
  ...
  return (
    <div className="contact-body">
      <SimpleBar className="nicescroll-bar">
        ...
        {authorizeDoAction(CHANGE_PERMISSIONS) && showOrganizationForm && (
          <OrganizationForm
            show={showOrganizationForm}
            close={() => setShowOrganizationForm(!showOrganizationForm)}
        ...
        {authorizeDoAction(DELETE_PERMISSIONS) && selectedDeleteRow && (
          <DeleteConfirmation
            ...
            warningMessage={`You are about to permanently delete the below organization - ${selectedDeleteRow.company_name}`}
            successMessage={`Organization - ${selectedDeleteRow.company_name} has been deleted successfully.`}
          />
        )}
...
export default ManageOrganizationAppBody;
